...
},
{
  ...
  },
  {
    ...
    answer:
      "Según lo informado por la constructora, las obras comienzan en el primer trimestre del año 2021.",
    clase: 2,
  },
  {
    id: 12,
    question: "¿Hay partes sin pavimento en Caribe Verde?",
    answer: "Toda la entrada y zonas principales están pavimentadas.",
    clase: 3,
  },
  {
    id: 13,
    ...
    answer:
      "El monto puede variar por muchos aspectos: Entidad bancaria, cantidad de años (15, 20, 30), monto final del crédito, etc. En nuestro grupo hay un estimado entre 250.000 y 550.000 pesos mensuales.",
    clase: 1,
  },
  {
    id: 14,
  ...
  {
    id: 15,
    question: "¿En que momento se comienza a pagar el crédito hipotecario?",
    answer:
      "Luego de firmar las escrituras y que el banco desembolse el dinero a la constructora.",
    clase: 3,
  },
  {
    id: 16,
  ...
  },
  {
    id: 17,
    question:
      "¿Las zona social de cada torre la entregan en obra gris o enchapado?",
    answer:
      "Los antecedentes de la constructora indican que esas areas las entregan con acabados sencillos.",
    clase: 2,
  },
  {
    id: 18,
    ...
    answer:
      "Hasta los momentos la constructora no nos ha ofrecido nada con relación a los acabados.",
    clase: 3,
  },
  {
    id: 19,
    ...
    answer:
      "Nos indicaron que estrato 2 con posibilidades de convertirse en 3.",
    clase: 1,
  },
  {
    id: 20,
    question:
      "¿Se puede construir un balcon despues de adquirir el apartamento?",
  ...
  },
  {
    id: 21,
    question:
      "¿El club de sotavento será de uso exclusivo de los propietarios?",
    answer:
      "Si, el club residencial es de uso exclusivo de los propietarios y no tendrá costo adicional al menos que se quiera hacer parte de actividades extracurriculares como Yoga, natación entre otras que si tendrán un costo adicional.",
    clase: 3,
  },
  {
    id: 22,
    question:
      "¿Se puede quitar la pared de la cocina del apartamento de 50mt2?",
  ...
  },
  {
    ...
    answer:
      "No, los ascensores son obligatorios solo para edificaciones mayores a 5 pisos.",
    clase: 2,
  },
  {
    id: 24,
    ...
    answer:
      "Una sola entrada, que servirá de punto de seguridad inicial para permitir el paso a los conjuntos internos ya que cada conjunto contará con una portería acorde a los renders ofrecidos por la constructora. ",
    clase: 3,
  },
  {
    id: 25,
  ...
  },
  {
    id: 26,
    question:
      "¿Sera una sola administración o cada conjunto de sotavento tendrá una?",
    answer:
      "Se cree que será una sola administración, todo el tema de administración se solucionara cuando los propietarios logren ocupar su apartamento, reunirse y conformen la asamblea general propietarios.",
    clase: 2,
  },
  {
    id: 27,
    question:
      "¿Cuáles son los proyectos residenciales más cercanos a Sotavento?",
    answer:
      "Conjunto Residencial Caribe Plaza, Conjunto Residencial Brisas del Caribe, Conjunto Residencial Altos de Caribe Verde, Encanto Caribe - próximamente",
    clase: 3,
  },
]
// {
